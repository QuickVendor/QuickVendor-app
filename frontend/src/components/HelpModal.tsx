...
const HelpModal: React.FC<HelpModalProps> = ({ isOpen, onClose, userContext }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Need Help?" maxWidth="md">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            rows={5}
            placeholder="Describe your issue, ask a question, or share feedback about your experience..."
            value={description}
          ...
          <div className="flex justify-between items-center mt-2">
            <p className="text-sm text-gray-500">
              We're here to help! Share anything on your mind.
            </p>
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          ...
          <p className="text-xs text-gray-500 mt-2">
            This context helps us understand and address your request better.
          </p>
        </div>
